...
public class Main {
    ...
    private static String input = "116\t1470\t2610\t179\t2161\t2690\t831\t1824\t2361\t1050\t2201\t118\t145\t2275\t2625\t2333\n" +
    ...
    public static List<List<Integer>> toIntListList() {
        List<String> rows = new ArrayList<>(asList(input.split("\n")));
        return rows.stream()
                .map(Main::mapToIntList)
                .collect(Collectors.toList());
    }

    private static List<Integer> mapToIntList(String input) {
